...
{:else if id == "checked40"}
	<svg class="w-8 h-8 text-white fill-current" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
		<path
			d="M20 3.33331C10.8 3.33331 3.33337 10.8 3.33337 20C3.33337 29.2 10.8 36.6666 20 36.6666C29.2 36.6666 36.6667 29.2 36.6667 20C36.6667 10.8 29.2 3.33331 20 3.33331ZM16.6667 28.3333L8.33337 20L10.6834 17.65L16.6667 23.6166L29.3167 10.9666L31.6667 13.3333L16.6667 28.3333Z"
		/>
	</svg>
{:else if id == "chevronDown"}
	<svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
		<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
	</svg>
{:else if id == "chevronUp"}
	<svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
{:else if id == "compare"}
	<svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" width="32" height="32" viewBox="0 0 32 32">
		<path
...
{:else if id == "play"}
	<svg id="icon" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" viewBox="0 0 32 32" stroke-width="3">
		<path
...
{:else if id == "slash"}
	<svg class="flex-shrink-0 h-5 w-5 text-neutral-300" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
...
{:else if id == "x"}
	<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" stroke="currentColor">
